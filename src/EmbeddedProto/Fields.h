...
namespace EmbeddedProto 
{
  ...
  inline uint32_t Field::serialized_size() const
  {
    ::EmbeddedProto::MessageSizeCalculator calcBuffer;
    this->serialize(calcBuffer);
    return calcBuffer.get_size();
...
#ifdef PARTIAL_SERIALIZATION_ENABLED
  inline Error Field::serialize_partial_tag_and_size(uint32_t field_number,
                                             uint32_t size,
                                             WriteBufferInterface& buffer,
                                             MessageState& state,
                                             bool optional) const
  ...
  inline Error Field::deserialize_partial_size_phase(ReadBufferInterface& buffer,
                                              MessageState& state) const
  {
    Error return_value = Error::NO_ERRORS;
  ...
  inline Error Field::serialize_len(const uint32_t field_number,
                             const uint32_t size,
                             WriteBufferInterface& buffer,
                             const bool optional) const
  {
  ...
  inline Error Field::serialize_scalar(const uint32_t field_number,
                                const WireFormatter::WireType wire_type,
                                const bool is_default,
                                WriteBufferInterface& buffer, 
                                const bool optional) const
